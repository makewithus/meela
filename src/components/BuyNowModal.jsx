...
const BuyNowModal = () => {
  ...
  const proceed = () => {
    ...
    if (selectedOption === "1") {
      ...
      // 3 bottles at AED 41.67 each (total AED 125)
      addToCart({
        id: "meela-hair-oil",
        name: "MEELA AYURVDIC Hair Growth Oil",
        price: 41.67,
    ...
    >
      ...
      >
        ...
        <div className="grid md:grid-cols-2 overflow-y-auto">
          ...
          <div className="p-2 sm:p-5 md:p-6 flex items-center justify-center bg-linear-to-br from-[#d4b5a0] to-[#c9a88a] min-h-[140px] sm:min-h-[280px] md:min-h-0">
            <div className="relative w-full max-w-[130px] sm:max-w-60 md:max-w-70">
          ...
          <div className="p-2.5 sm:p-5 md:p-6 flex flex-col pt-9 sm:pt-14">
            ...
            >
              Crafted with 65+ powerful herbs, our ISO & GMP certified Ayurvedic
              hair oil strengthens roots, fights dandruff, and promotes healthy
            ...
            <div className="mb-1 sm:mb-3">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label
                  className={`flex items-center justify-between p-2 sm:p-2.5 md:p-3 border-2 rounded-lg cursor-pointer hover:border-coffee hover:shadow-md transition-all active:scale-[0.98] ${selectedOption === "1" ? "border-coffee bg-cream" : "border-[#e0e0e0]"}`}
                >
                  <div className="flex items-center gap-1.5 sm:gap-3 flex-1 min-w-0">
                    <input
                      ...
                      className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-coffee shrink-0"
                    ...
                    >
                      <p className="font-semibold text-[#4a4a4a] text-[11px] sm:text-sm">
                        1 Bottle
                      </p>
                      <p className="text-[9px] sm:text-[10px] text-[#6a6a6a] mt-0.5">
                        100ml - AED 55.00
                      </p>
                    </div>
                  </div>
                  <p
                    className="text-base sm:text-lg md:text-xl font-bold text-[#4a4a4a] shrink-0 ml-1"
                    style={{ fontFamily: '"Poppins", sans-serif' }}
                  >
                    AED 55
                  </p>
                ...
                <label
                  className={`flex items-center justify-between p-2 sm:p-2.5 md:p-3 border-2 rounded-lg cursor-pointer hover:border-coffee hover:shadow-md transition-all relative active:scale-[0.98] ${selectedOption === "2" ? "border-coffee bg-cream" : "border-[#e0e0e0]"}`}
                >
                  <div className="flex items-center gap-1.5 sm:gap-3 flex-1 min-w-0">
                    <input
                      type="radio"
                    ...
                    >
                      <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
                        ...
                        <span className="bg-[#d9534f] text-white text-[8px] sm:text-[9px] font-bold px-1 sm:px-2 py-0.5 rounded-md whitespace-nowrap">
                          SAVE AED 15
                        </span>
                      </div>
                      <p className="text-[9px] sm:text-[10px] text-[#6a6a6a] mt-0.5">
                  ...
                  <p
                    className="text-base sm:text-lg md:text-xl font-bold text-[#5cb85c] shrink-0 ml-1"
                    style={{ fontFamily: '"Poppins", sans-serif' }}
                  >
                    AED 95
                  </p>
                ...
                <label
                  className={`flex items-center justify-between p-2 sm:p-2.5 md:p-3 border-2 rounded-lg cursor-pointer hover:border-coffee hover:shadow-md transition-all relative active:scale-[0.98] ${selectedOption === "3" ? "border-coffee bg-cream" : "border-[#e0e0e0]"}`}
                >
                  <div className="flex items-center gap-1.5 sm:gap-3 flex-1 min-w-0">
                    <input
                      type="radio"
            ...
            <div className="mb-1 sm:mb-3 p-1.5 sm:p-2.5 bg-[#d4edda] border-l-4 border-[#5cb85c] rounded-lg">
              <p
                className="text-[10px] sm:text-xs text-[#155724] font-medium flex items-center gap-1"
                style={{ fontFamily: '"Poppins", sans-serif' }}
              >
                <span className="text-[11px] sm:text-sm">✓</span> Free delivery
                all over UAE
              </p>
            </div>
